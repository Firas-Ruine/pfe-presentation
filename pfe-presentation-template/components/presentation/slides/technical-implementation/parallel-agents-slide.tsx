        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="flex justify-center items-center space-x-8">
            <Card className="shadow-md bg-red-500/10 border-red-500/30">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-3xl font-bold text-red-500">~6s</div>
                <div className="text-sm text-muted-foreground">Sequential</div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-md bg-green-500/10 border-green-500/30">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-sm text-muted-foreground">Parallel (Send API)</div>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="shadow-lg">
            <CardHeader className="pb-2">
              <CardTitle className="text-base">LangGraph Send() API Usage</CardTitle>
            </CardHeader>
            <CardContent>
              ...
              <Card key={index} className="shadow-md">
                <CardHeader className="pb-2">
                  <CardTitle className="flex items-center text-sm">
                    <div className={`p-2 rounded ${agent.color} text-white mr-2`}>
                ...
                <CardContent className="pt-0">
                  <Badge variant="outline" className="text-xs mb-2">{agent.source}</Badge>
