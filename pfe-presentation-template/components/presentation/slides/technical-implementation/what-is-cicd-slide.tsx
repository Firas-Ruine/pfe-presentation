          ...
          <div className="grid md:grid-cols-2 gap-10 lg:gap-12">
            ...
            <div className="flex flex-col space-y-8">
              ...
              <Card className="w-full bg-card border border-border/70 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                <CardContent className="p-8 space-y-6">
                  <div className="text-center space-y-3">
                    ...
                    <Badge
                      variant="outline"
                      className="text-lg font-medium border-primary/30 text-primary bg-primary/5 px-4 py-2"
                    >
              ...
              <div className="space-y-6 pt-6">
                <h3 className="text-2xl font-semibold text-center">Avantages clés</h3>
            ...
            <div className="flex flex-col space-y-5">
                    ...
                    <CardContent className="p-5">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 space-y-1.5">
                          <h3 className="font-semibold text-xl">{component.title}</h3>
                          <p className="text-lg text-muted-foreground">{component.description}</p>
                          <p className="text-base text-muted-foreground/80 pt-1">
              ...
              <Card className="bg-muted/50 border border-dashed border-border/70 rounded-lg mt-2">
                <CardHeader className="pb-3 pt-5">
                  <CardTitle className="text-xl font-semibold text-center">Pipeline CI/CD</CardTitle>
                </CardHeader>
                <CardContent className="p-5">
                  <div className="flex items-center justify-around text-lg text-muted-foreground flex-wrap gap-x-4 gap-y-3">
                    {[
                      ...
                      <React.Fragment key={item.label}>
                        ...
                        {idx < arr.length - 1 && (
                          <ArrowRight className="h-6 w-6 text-muted-foreground/70 hidden sm:inline-block" />
                        )}
                      </React.Fragment>
                    ))}
                  </div>
