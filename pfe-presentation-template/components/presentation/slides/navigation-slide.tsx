...
const sections = [
  ...
  { title: "Présentation de l'entreprise et du contexte", icon: Building, time: "8 min", targetSlide: 6 },
  { title: "Problématique et Besoins Métier", icon: AlertTriangle, time: "10 min", targetSlide: 7 },
  { title: "Solution proposée et Architecture Cible", icon: Rocket, time: "12 min", targetSlide: 10 },
  { title: "Méthodologie & Approche d'Ingénierie", icon: Settings, time: "10 min", targetSlide: 9 },
  { title: "Conception & Implémentation des Microservices", icon: Code, time: "15 min", targetSlide: 11 },
  { title: "CI/CD, Monitoring, Tests & Sécurité", icon: TestTube, time: "15 min", targetSlide: 17 },
  { title: "Validation, Résultats et Retours", icon: Award, time: "12 min", targetSlide: 21 },
  { title: "Conclusion et Perspectives", icon: GraduationCap, time: "8 min", targetSlide: 25 },
]
