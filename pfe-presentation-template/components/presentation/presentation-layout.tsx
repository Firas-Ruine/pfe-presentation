...
export default function PresentationLayout({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-background via-blue-50 to-secondary/10 dark:from-slate-900 dark:via-slate-800 dark:to-blue-900/30">
      ...
      <main className="flex-1">{slides[currentSlide]}</main>

      <footer className="py-4 text-center text-xs text-muted-foreground border-t border-border/40 bg-background/95">
